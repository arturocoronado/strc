...
<div class="pagina">
    ...
    <div class="" style="margin: auto;position: absolute;left:0;right: 0;display: block;width: 400px;height: 100px;text-align: center">
        <p class="title">DATOS DEL CÓNYUGUE, CONCUBINA O CONCUBINARIO Y/O DEPENDIENTES ECONÓMICOS (SITUACIÓN ACTUAL)</p>

    </div>
    @forelse ($dependientes as $d)
    ...
    <div class="" style="border: 1px solid #000;
         border-radius: 5px;display: block;padding: 5px;margin: auto; position: absolute;left:0;right: 0;width: 650px;height: 100px;">
        <p>Sin datos de dependientes agregados</p>
    </div>
