...
class AddInmueblesOpe extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dec_inmuebles_ope', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->decimal('Inversion_Obra', 10, 2)->nullable();
    ...
    {
        Schema::dropIfExists('dec_inmuebles_ope');
    }
}
